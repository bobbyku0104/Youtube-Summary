...
const Home = () => {
  return (
    <div className="min-h-screen bg-[#020617] flex flex-col items-center overflow-hidden relative">
      ...
      <main className="flex flex-col items-center text-center mt-10 px-4 z-10 relative">
        <BgGradient />
        ...
        <p className="text-gray-600 text-lg md:text-xl max-w-2xl mt-6">
          Paste a YouTube link to generate an instant summary, extract key
          moments, and chat with AI about the content.
        </p>
