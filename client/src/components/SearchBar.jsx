      ...
      <div className="relative w-full">
        ...
        <input 
          ...
          className={`w-full bg-[#0f172a] border rounded-xl py-4 pl-12 pr-4 text-white focus:outline-none 
            ${error ? "border-red-500" : "border-gray-800"} focus:border-indigo-500 transition-colors duration-100`}
        />
        <p className={`text-red-500 text-sm mt-1 transition-opacity duration-500 ${error ? "opacity-100" : "opacity-0"}`}>
          {error}
        </p>
      </div>
